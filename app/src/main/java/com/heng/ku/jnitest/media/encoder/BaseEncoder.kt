package com.heng.ku.jnitest.media.encoder
...
//                    }
    ...
    private fun encode(frame: Frame) {
        ...
        if (dequeueInputBufferIndex > -1) {
            val byteBuffer = mediaCodec.getInputBuffer(dequeueInputBufferIndex) ?: return
            byteBuffer.clear()
...
//                        }
                        ...
                        val outputBuffer = mediaCodec.getOutputBuffer(outputIndex) ?: return
